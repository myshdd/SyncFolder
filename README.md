...
## Использование через Планировщик заданий Windows
...
3. При проблемах с правами проверьте, что:
   - Учётная запись имеет доступ к исходной и целевой папкам.
...
- `ACTION` — реальные действий (копирование, удаление, создание папок);
